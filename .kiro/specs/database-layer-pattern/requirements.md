...
## RF-006 - Criação Automática de Tabelas (lifespan)
...
## RF-007 - Integração com Docker Compose
...
- Autenticação, autorização ou qualquer lógica de negócio nos serviços `ads` e `trades`
- Rotas de API além do `GET /health` já existente — apenas a infraestrutura de banco é criada
